 ...
 * @private
 */
function _load(filePath, applyEnvironments, relativeTo) {
...
// cache the configuration lookup for repeated paths
var load = _.memoize(_load, function(filePath, applyEnvironments, relativeTo) {
    return [filePath, applyEnvironments, relativeTo].join("");
});
