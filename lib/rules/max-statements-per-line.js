...
module.exports = {
    ...
    create: function(context) {
        ...
        var DANGLING_HOST_TYPE = /^(?:DoWhile|For|ForIn|ForOf|If|Labeled|While)Statement$/;
        ...
        function enterStatement(node) {
            ...
            // Skip to allow dangling statements if this is direct child of control statements.
            // `if (a) foo();` is counted as 1.
            // But `if (a) foo(); else foo();` is counted as 2.
            if (DANGLING_HOST_TYPE.test(node.parent.type) &&
